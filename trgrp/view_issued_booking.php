<?php
	...
	$status = "";
	$issue_date = "";
	$query = "select package_name,name,email,mobile,address,status,issue_date from issued_bookings left join guest on issued_bookings.guest_id=guest.id  where tg = '$tg'";
?>
<!DOCTYPE html>
<html>
<head>
